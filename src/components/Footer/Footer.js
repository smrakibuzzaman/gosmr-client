...
</svg> info@gosmrtravelbooking.com</li>
...
<h1>Quick Links</h1>
<ul className="list-unstyled">
<li><Link to="/home" className="text-light decoration">Home</Link></li>
<li><Link to="/aboutUs" className="text-light decoration">About Us</Link></li>
<li><Link to="/tourPackages" className="text-light decoration">Tour Packages</Link></li>
<li><Link to="/blog" className="text-light decoration">Blog</Link></li>
</ul>
                </Col>
            </Row>
        </div>
        ...
        <div>
            <h6>Copyright@gosmrtravelbooking</h6>
        </div>
